...
function disposeDecorationsForEditedLines(editedLine: TextDocumentContentChangeEvent[], context: StyledColorsContext) {
...
function getEditedLines(editedLine: TextDocumentContentChangeEvent[], context: StyledColorsContext, diffLine: number) {
...
function getDecorationsToStyledColors(colors: LineExtraction[], variables: LineExtraction[]): Map<number, IDecoration[]> {
...
function* handleVisibleRangeEvent() {
   ...
   const decorations = getDecorationsToStyledColors(colors, variables)
