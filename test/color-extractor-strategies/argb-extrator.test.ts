...
describe('ARGB color extractor', () => {
   describe('[SHORT] Test extractor output', () => {
      it('Should correctly extract #fff', () => {
      ...
      it('Should correctly extract #000', () => {
   ...
   describe('Test extractor output', () => {
      ...
      it('Should correctly extract #000000', () => {
      ...
      it('Should correctly extract #0011AA33', () => {
   ...
   describe('[0x prefix][SHORT] Test extractor output', () => {
      it('Should correctly extract 0xfff', () => {
      ...
      it('Should correctly extract 0x000', () => {
   ...
   describe('[0x prefix]Test extractor output', () => {
      it('Should correctly extract 0xffffff', () => {
      ...
      it('Should correctly extract 0x000000', () => {
      ...
      it('Should correctly extract 0x0011AA33', () => {
