...
import { DECLARATION_REGEXP, REGEXP } from '../../src/lib/variables/strategies/stylus-strategy'
...
describe('Test variables declaration Regex', () => {
   // stylus variables
   it('Should match (stylus variables)', () => {
   ...
   it('Should not match (stylus variables)', () => {
