...
import type * as styleColors from '../src/extension'

const ext: vscode.Extension<styleColors.StyledColorsContext> = vscode.extensions.getExtension('nyxb.vscode-styled-colors')
